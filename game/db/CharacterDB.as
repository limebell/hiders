	...
	public class CharacterDB {
...

		{
			...
			addCharacter("Temp",
							...
							5, 5, 100, 100, SkillDB.getSkill(SkillDB.TEMPSKILL), new testCharacter());
			
			addCharacter("Temp2",
							"임시 캐릭터 그 두번째 입니다. 임시로 만들어 졌지만 기쁜 얼굴을 하고 있습니다. 능력치는 걍 내맘대로 설정한 수치이므로 이 수치가 좋은 것일수도, 안좋은 것일수도 있습니다. 또 그리기 귀찮아서 그냥 그대로 우려먹었습니다.",
							6, 4, 90, 110, SkillDB.getSkill(SkillDB.TEMPSKILL2), new testCharacter2());
		}
		
		private static function addCharacter(charName:String, description:String, baseATK:int, baseDEF:int, baseHP:int, baseST:int, skill:SkillData, clip:MovieClip):void {
